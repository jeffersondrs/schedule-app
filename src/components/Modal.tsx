...
export default function Modal({ children, isOpen, isClose }: ModalProps) {
  return (
    <>
      {isOpen && (
        <div className="fixed px-6 pt-20 pb-10 top-0 left-0 w-full h-full bg-black bg-opacity-50 z-40 flex justify-center items-center overflow-auto backdrop-blur-sm">
