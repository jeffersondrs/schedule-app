...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-start items-center h-full w-96 bg-gray-950 gap-3">
      <header className="flex flex-col justify-center items-start">
        ...
        <div className="flex flex-col justify-center items-start w-[350px] gap-2">
